...
public class dummy implements Serializable{
	...
	public String generateStudents (){
		...
		String [] lastnameList = {"admin", "123", "Mayer","Schönefeld","Brummer","Tannenbaum","Goldmann","Fischermann","Silbermann","Schuhmacher","Holzmann","Wassermann"};
		...
		String [] keywordList = {"admin", "123", "sdklög","ösdkkfjg","södgh","uiouior","diordigh","kjdfgss","pweornb","mdflkgdf","dfgdfg","ödkfgjsdäflg"};
