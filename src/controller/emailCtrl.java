...
public String sendEmail(String email, String courseName) {
 ...
 try {
  ...
  message.setText("Ergebnisse in Pr�fungsfach " + courseName + ", " +
  		"\nStudienabschnittsversion PO vom 08.10.2007, " +
  		"\nPr�fungsfachversion Standard sind ab sofort einsehbar. " +
  		"\n\n Diese automatisch versandte Email informiert Sie �ber die Verbuchung des Ergebnisses der oben genannten Pr�fung. " +
  		"\nBitte antworten Sie NICHT auf diese Email. " +
  		"\nBitte haben Sie Verst�ndnis daf�r, dass wegen Datenschutz Pr�fungsergebnisse nicht per Email bekannt gegeben werden d�rfen. " +
